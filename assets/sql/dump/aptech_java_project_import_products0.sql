...
CREATE TABLE `import_products` (
  ...
  CONSTRAINT `import_products_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
-- Dump completed on 2021-09-22  7:37:50
